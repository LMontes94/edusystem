...
- `users` — CRUD, avatar (MinIO), change password
...
- `justifications` — justificar inasistencias, actas automáticas por umbral
- `announcements` — draft/publish workflow
- `indicators` — por materia + grado + año lectivo
- `convivencias` — tipos: observation/warning/reprimand/commendation/suspension/parent_meeting
...
- `notifications` — push tokens, BullMQ queues
...
/admin/attendance      — tomar lista + historial + justificaciones
/admin/attendance-detail — resumen por alumno con filtro mensual
/admin/announcements
...
- [ ] Pantalla de actas de inasistencia (frontend)
- [ ] Detalle de asistencia — desglose por curso para directivos
- [ ] Notificaciones push a padres desde actas y convivencias
