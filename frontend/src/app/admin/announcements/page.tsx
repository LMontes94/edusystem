...
import {
  ...
  usePublishAnnouncement, useDeleteAnnouncement, Announcement,
...
export default function AnnouncementsPage() {
  ...
  const form = useForm<CreateForm>({
    ...
    defaultValues: { title: '', content: '', scope: 'INSTITUTION', courseId: '' },
  });
  ...
  async function onSubmit(data: CreateForm) {
    const payload = { ...data, courseId: data.scope === 'COURSE' ? data.courseId : undefined };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Ocultar botón si está en licencia */}
        {!isOnLeave && (
      ...
      {/* Dialog — solo accesible si no está en licencia */}
      {!isOnLeave && (
                ...
                <FormField control={form.control} name="content"
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <textarea
                          className="flex min-h-[120px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm resize-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring placeholder:text-muted-foreground"
            ...
            <Card key={announcement.id}>
              <CardHeader className="pb-2 pt-4 px-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  {/* Acciones — ocultas si está en licencia */}
                  {!isOnLeave && (
